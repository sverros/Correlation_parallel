...
def initialize(shakemap, uncertainty, stationdata, vscorr, dm=1, dn=1):
    ...
    # OUT:M,N - number of points vertically and horozontally
    #     K- number of stations
    #     uncertaintydata- uncertainty data at each point
    #     site_collection_SM- site collection for ShakeMap data
    #     site_collection_station- site collection for station data
    #     location_lat/lon_g- lat and lons for grid data
    ...
    return {'M': M, 'N': N, 'K': K, 'uncertaintydata':uncertaintydata, 
            'site_collection_SM':site_collection_SM, 'site_collection_station':site_collection_station, 
            'location_lat_g': location_lat_g, 'location_lon_g':location_lon_g, 'data':DATA, 
            'intensity':intensity, 'site_collection_both':site_collection_both}
